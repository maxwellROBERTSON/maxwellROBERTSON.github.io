    ...
    <nav role="tablist" aria-label="Main navigation">
      ...
      <div class="dropdown">
        ...
        <div id="myDropdown" class="dropdown-content">
          <a href="/Maxwell_Robertson_CV.pdf" target="_blank">Graphics CV</a>
          <a href="/Maxwell_Robertson_CV_gen.pdf" target="_blank">General CV</a>
        </div>
      </div>
...
`;const u=document.querySelectorAll('nav button[role="tab"]'),l=document.querySelectorAll("main section");function m(){const t=document.querySelector(".btn-toggle"),o=document.querySelector("nav");if(!t||!o)return;const e=t.offsetWidth,s=o.parentElement.offsetWidth-e-16;o.style.width=`${s}px`}window.addEventListener("load",m);window.addEventListener("resize",m);function f(t){u.forEach(o=>{o.classList.remove("active"),o.setAttribute("aria-selected","false"),o.setAttribute("tabindex","-1")}),t.classList.add("active"),t.setAttribute("aria-selected","true"),t.setAttribute("tabindex","0"),t.focus()}function p(t){l.forEach(n=>{n.classList.remove("visible");const s=n.querySelector("h2");s&&s.classList.remove("highlighted")}),t.classList.add("visible");const o=t.querySelector("h2");o&&o.classList.add("highlighted");const e=t.id,i=document.querySelector(`nav button[data-target="${e}"]`);i&&f(i)}const b=document.querySelector("header").offsetHeight,S=b+10;function x(t,o=500){const e=window.scrollY,i=t-e,n=performance.now();function s(r){const g=r-n,h=Math.min(g/o,1),y=a(h);window.scrollTo(0,e+i*y),h<1&&requestAnimationFrame(s)}function a(r){return r<.5?2*r*r:-1+(4-2*r)*r}requestAnimationFrame(s)}u.forEach(t=>{t.addEventListener("click",o=>{o.preventDefault();const e=t.getAttribute("data-target"),i=document.getElementById(e);if(i){f(t);const n=document.querySelector("header").offsetHeight,a=i.getBoundingClientRect().top+window.scrollY-n-10;x(a)}})});function v(){const t=S,o=window.innerHeight;let e=null;for(let i=0;i<l.length;i++){const n=l[i],s=n.querySelector("h2");if(!s)continue;const a=s.getBoundingClientRect(),r=a.top;if(a.bottom>t&&a.top<o){p(n);return}r<t&&(e=n)}e?p(e):l.length>0&&p(l[0])}window.addEventListener("scroll",v);window.addEventListener("load",v);document.getElementById("downloadCV").addEventListener("click",function(t){t.stopPropagation(),document.getElementById("myDropdown").classList.toggle("show")});window.addEventListener("click",function(){const t=document.getElementById("myDropdown");t.classList.contains("show")&&t.classList.remove("show")});const w=document.getElementById("darkModeToggle"),M=w.querySelector(".label");w.addEventListener("click",()=>{document.body.classList.toggle("dark"),M.textContent=document.body.classList.contains("dark")?"Light Mode":"Dark Mode"});const E=document.querySelectorAll("video");E.forEach(t=>{t.play().catch(o=>{console.warn("Video play failed:",o)})});const k=document.querySelectorAll(".show_btn");k.forEach(t=>{t.addEventListener("click",()=>{const o=t.closest("li");if(!o)return;const e=o.querySelector(".collapsible");if(e)if(document.querySelectorAll(".collapsible.expanded").forEach(i=>{if(i!==e){i.style.height=i.scrollHeight+"px",i.offsetHeight,i.style.transition="height 1.0s ease",i.style.height="6rem",i.addEventListener("transitionend",function s(){i.classList.remove("expanded"),i.style.height="",i.style.transition="",i.removeEventListener("transitionend",s)});const n=i.closest("li").querySelector(".show_btn");n&&(n.textContent="Show More")}}),e.classList.contains("expanded")){const i=e.scrollHeight;e.style.height=i+"px",e.offsetHeight,e.style.transition="height 1.0s ease",e.style.height="6rem",e.addEventListener("transitionend",function n(){e.classList.remove("expanded"),e.style.height="",e.style.transition="",e.removeEventListener("transitionend",n)}),t.textContent="Show More"}else{e.classList.add("expanded");const i=e.scrollHeight;e.style.height="6rem",e.offsetHeight,e.style.transition="height 1.0s ease",e.style.height=i+"px",e.addEventListener("transitionend",function n(){e.style.height="auto",e.style.transition="",e.removeEventListener("transitionend",n)}),t.textContent="Show Less"}})});const c=["1Shadow Mapping.png","2PCF 3x3.png","3PCF 9x9.png","4VSM 3x3.png","5VSM 9x9.png","6ESM 3x3.png","7ESM 9x9.png","8Shadow Mapping.png","9PCF 3x3.png","10PCF 9x9.png","11VSM 3x3.png","12VSM 9x9.png","13ESM 3x3.png","14ESM 9x9.png","15Shadow Mapping.png","16PCF 3x3.png","17PCF 9x9.png","18VSM 3x3.png","19VSM 9x9.png","20ESM 3x3.png","21ESM 9x9.png"];c.sort((t,o)=>{const e=parseInt(t.match(/^\d+/)[0],10),i=parseInt(o.match(/^\d+/)[0],10);return e-i});const C=document.getElementById("shadowMappingImg"),I=document.getElementById("shadowMappingCaption"),L="/Shadow_Mapping/";let d=0;setInterval(()=>{C.src=L+c[d];const o=c[d].replace(/^\d+\s*/,"").replace(/\.png$/i,"");I.textContent=o,d=(d+1)%c.length},1e3);const _=document.getElementById("gymVideo");_.playbackRate=2;
